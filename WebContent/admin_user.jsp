									...
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
													<%--@declare id="updatebookname"--%><input type="text" class="form-control" id="updatename" name="name"  placeholder="">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">邮箱</label>
												<div class="col-sm-7">
													<%--@declare id="updateauthor"--%><input type="text" class="form-control" id="updateemail" name="email" placeholder="">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">手机号</label>
												<div class="col-sm-7">
													<%--@declare id="updatepress"--%><input type="text" class="form-control" id="updatephone" name="phone"  placeholder="">
...
<%--suppress XmlDuplicatedId --%>
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">可借阅天数</label>
												<div class="col-sm-7">
<%--suppress XmlDuplicatedId --%>
													<%--@declare id="addnum"--%><input type="text" class="form-control" name="lend_num" id="updatelend_num" required="required"  placeholder="请输入可借阅天数">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
			<input type="text" class="form-control" id="name" name="name" placeholder="请输入您的真实姓名" value='<% AdminBean admin=null;out.write(admin.getName());%>'>
